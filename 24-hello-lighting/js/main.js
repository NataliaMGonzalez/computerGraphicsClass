...
let renderer, scene, camera, box, cameraControls, gui, stats, pointlight;
window.anim = false;
...
function init(event) {
    ...
    let params = {
        ...
        pointLightColor: new THREE.Color(1,1,1)
    }
    ...
    gui.addColor(params, "pointLightColor").name("Point Light Color").listen().onChange(function(color){
        pointlight.color = new THREE.Color(color.r/255, color.g/255, color.b/255);
    });
